...
import (
	...
	"github.com/chagasVinicius/go-starter/app/services/go-starter-api/handlers"
	"github.com/chagasVinicius/go-starter/internal/sys/database"
	"github.com/chagasVinicius/go-starter/internal/web/debug"
	"github.com/chagasVinicius/go-starter/kit/logger"
	"github.com/chagasVinicius/go-starter/kit/opentel"
...
func main() {
	log, err := logger.New("go-starter-api")
	if err != nil {
		fmt.Println(err)
		os.Exit(1)
	}
...
func run(log *zap.SugaredLogger) error {
	...
	cfg := struct {
		...
		Trace struct {
			...
			ServiceName string  `conf:"default:go-starter-api"`
